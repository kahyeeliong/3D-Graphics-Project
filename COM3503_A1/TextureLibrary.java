...
public class TextureLibrary {
  ...
  public void add(GL3 gl, String name, String filename, boolean repeat) {
    Texture texture = loadTexture(gl, filename, repeat);
  ...
  public Texture loadTexture(GL3 gl3, String filename, boolean repeat) {
    Texture t = null; 
    try {
      ...
      // new code
      if (repeat) {
        t.setTexParameteri(gl3, GL3.GL_TEXTURE_WRAP_S, GL3.GL_REPEAT); // Repeat horizontally
        t.setTexParameteri(gl3, GL3.GL_TEXTURE_WRAP_T, GL3.GL_REPEAT); // Repeat vertically
    } else {
        t.setTexParameteri(gl3, GL3.GL_TEXTURE_WRAP_S, GL3.GL_CLAMP_TO_EDGE); // Don't repeat horizontally
        t.setTexParameteri(gl3, GL3.GL_TEXTURE_WRAP_T, GL3.GL_CLAMP_TO_EDGE); // Don't repeat vertically
      }
    }
    catch(Exception e) {
